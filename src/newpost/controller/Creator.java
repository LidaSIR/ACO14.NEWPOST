...
public class Creator {
    ...
    public static PostTicket ticketCreator(Client client){
        ...
        estimationArrivalDate.setDay(currentTime.getDay()+ daysInRoad);

        return new PostTicket(client,productsCreator(),addressCreator(),
                addressCreator(),currentTime, estimationArrivalDate);
    }
}